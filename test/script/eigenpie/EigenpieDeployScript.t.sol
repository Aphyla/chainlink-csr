...
contract EigenpieDeployScriptTest is Test, EigenpieParameters {
    ...
    function test_Deploy() public {
...

        {
            ...
            assertEq(ccipAdapter.LINK_TOKEN(), address(0), "test");
            assertEq(ccipAdapter.CCIP_ROUTER(), ETHEREUM_CCIP_ROUTER, "test_Deploy::12");
            assertEq(ccipAdapter.L1_TOKEN(), ETHEREUM_EGETH_TOKEN, "test_Deploy::13");
        }
...

        {
            ...
            assertEq(dataFeed, ARBITRUM_EGETH_ETH_DATAFEED, "test_Deploy::18");
            assertEq(isInverse, ARBITRUM_EGETH_ETH_DATAFEED_IS_INVERSE, "test_Deploy::19");
            assertEq(heartbeat, ARBITRUM_EGETH_ETH_DATAFEED_HEARTBEAT, "test_Deploy::20");
            ...
            assertEq(oraclePool.TOKEN_OUT(), ARBITRUM_EGETH_TOKEN, "test_Deploy::24");
