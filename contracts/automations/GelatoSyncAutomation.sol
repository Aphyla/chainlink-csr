...
/**
 * @title GelatoSyncAutomation Contract
 * @dev A contract that automates the synchronization of native tokens to another chain using the Gelato automation framework.
 ...
 */
contract GelatoSyncAutomation is AutomationCompatible, Ownable, ISyncAutomation {
    ...
    /**
     * @dev Function called by the Gelato Keeper network to check if the upkeep is needed.
        ...
        returns (bool upkeepNeeded, bytes memory performData)
    {
        ...
        performData = abi.encodeWithSelector(this.performUpkeep.selector, performData);
    }

    /**
     * @dev Function called by the Gelato Keeper network to perform the upkeep.
